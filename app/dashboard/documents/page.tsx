    ...
    <div className="min-h-screen bg-background pb-24">
      ...
      <div className="bg-gradient-to-r from-blue-500 to-cyan-500 text-white p-6 sticky top-0 z-10">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-blue-100 text-sm">Upload and manage your medical documents</p>
        </div>
      </div>
      ...
      <div className="max-w-4xl mx-auto p-6">
        ...
        <Card className="p-6 bg-card border border-border mb-6">
          <h2 className="text-xl font-bold text-card-foreground mb-4">Upload Document</h2>
